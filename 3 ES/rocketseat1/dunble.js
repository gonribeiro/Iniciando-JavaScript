...
console.log(Matematica.soma(2, 2)); // constantes

var a = 1; // a = 25; // erro ao redefinit
...
console.log(teste2()); // valores padrões
...
mostraNome(cliente2); // operadores rest / spread
// rest

var nome2 = cliente2.nome2,
    resto = _objectWithoutProperties(cliente2, ["nome2"]);
...
var cliente3 = _objectSpread(_objectSpread({}, cliente2), {}, {
  nome: 'Ciclano'
});

console.log(cliente3); // template literals

console.log('Meu nome é ' + cliente2.nome + ' e tenho ' + cliente2.idade + ' anos');
console.log("Meu nome \xE9 ".concat(cliente2.nome, " e tenho ").concat(cliente2.idade, " anos")); // object short syntax
